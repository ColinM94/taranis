...
export const GameScreen = (): JSX.Element => {
  ...
  const { isPaused, setIsPaused, fov } = useGameStore()

  const sphereRef = React.useRef<Mesh>(null)
  const camera = React.useRef<PerspectiveCameraType>(null)
  const pointerControls = React.useRef<PointerLockControlsType>(null)
  // const sun = React.useRef<Sphere>(null)
  ...
  return (
    <group>
      <group>
        ...
        <pointLight position={[99, 99, 99]} intensity={100000} />
      </group>
